...
education:
  Ph.D., Electrical Engineering, UC Riverside, 2014
---
...
- **DAD++: Improved Data-free Test Time Adversarial Defense**  
  G. K. Nayak, I. Khatri, S. Randive, R. Rawal, **A. Chakraborty**  
  *Neurocomputing* [In press]

- **Adaptive Self-Distillation for Minimizing Client Drift in Heterogeneous Federated Learning**  
  M. Yashwanth, G. K. Nayak, A. Singh, Y. Simmhan, **A. Chakraborty**  
  *Transactions on Machine Learning Research (TMLR)*

- **CARL: Cost-optimized Online Container Placement on VMs using Adversarial Reinforcement Learning**  
  P. S. Vinayak, S. S. Mallick, J. Lakshmi, **A. Chakraborty**, Y. Simmhan  
  *IEEE Transactions on Cloud Computing (TCC)*

- **An Unsupervised Group Detection Method for Understanding Group Dynamics in Crowds**  
  N. Choubey, A. Verma, **A. Chakraborty**  
  *Physica A: Statistical Mechanics and its Applications* 655 (2024): 130195

- **Robust Few-shot Learning Without Using any Adversarial Samples**  
  G. K. Nayak, R. Rawal, I. Khatri, **A. Chakraborty**  
  *IEEE Transactions on Neural Networks and Learning Systems (T-NNLS)*, 2024

- **Improving Domain Adaptation through Class Aware Frequency Transformation**  
  V. Kumar, H. Patil, R. Lal, **A. Chakraborty**  
  *International Journal of Computer Vision (IJCV)* (2023) 131(11):2888-2907

- **Multimodal Query-guided Object Localization**  
  A. Tripathi, R. R. Dani, A. Mishra, **A. Chakraborty**  
  *Multimedia Tools and Applications* (2023): 1-25

- **Mining Data Impressions from Deep Models as Substitute for the Unavailable Training Data**  
  G. K. Nayak, M. K. Reddy, S. Jain, **A. Chakraborty**  
  *IEEE Transactions on Pattern Analysis and Machine Intelligence (T-PAMI)* (2021) 44(11): 8465-8481

- **EvAn: Neuromorphic Event-Based Sparse Anomaly Detection**  
  A. Lakshmi, **A. Chakraborty**, C. S. Thakur  
  *Frontiers in Neuroscience* (2022) 15 (2021): 853

- **Robust Gait Based Human Identification on Incomplete and Multi-view Sequences**  
  U. Shreemali, **A. Chakraborty**  
  *Multimedia Tools and Applications* (2020) 80(7): 10141-10166

- **PerSeg: Segmenting Salient Objects From Bag of Single Image Perturbations**  
  A. Majumder, R. Venkatesh Babu, **A. Chakraborty**  
  *Multimedia Tools and Applications* (2020) 79(3): 2473-2493

- **Operator-in-the-Loop Deep Sequential Multi-Camera Feature Fusion for Person Re-Identification**  
  K. L. Navaneet, R. K. Sarvadevabhatla, S. Shekhar, R. Venkatesh Babu, **A. Chakraborty**  
  *IEEE Transactions on Information Forensics & Security* (2019) 15: 2375-2385

- **Neuromorphic vision: From sensors to event based algorithms**  
  A. Lakshmi, **A. Chakraborty**, C. S. Thakur  
  *Wiley Interdisciplinary Reviews: Data Mining and Knowledge Discovery* (2019) 9(4): p.e1310

- **Person Re-identification Using Multiple Egocentric Views**  
  **A. Chakraborty**, B. Mandal, J. Yuan  
  *IEEE Transactions on Circuits and Systems for Video Technology* (2017) 27(3):484-498

- **Optimal Landmark Selection for Registration of 4D Confocal Image Stacks in Arabidopsis**  
  K. Mkrtchyan, **A. Chakraborty**, A. K. Roy-Chowdhury  
  *IEEE/ACM Transactions on Computational Biology and Bioinformatics* (2017) 14(2):457-467

- **Network Consistent Data Association**  
  **A. Chakraborty**, A. Das, A. K. Roy-Chowdhury  
  *IEEE Transactions on Pattern Analysis and Machine Intelligence* (2016) 38(9):1859-1871

- **Context Aware Spatio-temporal Cell Tracking In Densely Packed Multilayer Tissues**  
  **A. Chakraborty**, A. K. Roy-Chowdhury  
  *Medical Image Analysis* (2015) 19(1):149-163

- **A Context-Aware Delayed Agglomeration Framework for Electron Microscopy Segmentation**  
  T. Parag, **A. Chakraborty**, S. Plaza, L. Scheffer  
  *PLoS ONE* (2015) 10(5): e0125825

- **Graph-based Active Learning of Agglomeration (GALA): a Python library to segment 2D and 3D neuroimages**  
  J. Nunez-Iglesias, R. Kennedy, S. M. Plaza, **A. Chakraborty**, W. T. Katz  
  *Frontiers in Neuroinformatics* (2014) 8(00034)
...
- **Adaptive Geometric Tessellation for 3D Reconstruction of Anisotropically Developing Cells in Multilayer Tissues from Sparse Volumetric Microscopy Images**  
  **A. Chakraborty**, M. M. Perales, G. V. Reddy, A. K. Roy-Chowdhury  
  *PLoS ONE* (2013) 8(8): e67202

- **Adaptive Cell Segmentation and Tracking for Volumetric Confocal Microscopy Images of A Developing Plant Meristem**  
  M. Liu\*, **A. Chakraborty**\*, D. Singh, M. Gopi, R. Yadav, G.V. Reddy, A. K. Roy-Chowdhury (\* Jointly first authored)  
  *Molecular Plant* (2011) 4(5): 922-931
...
- **O3SLM: Open Weight, Open Data, and Open Vocabulary Sketch-Language Model**  
  R. Gupta, M. Karuppasamy, S. Marjit, A. Tripathi, **A. Chakraborty**  
...
- **FedSCAl: Leveraging Server and Client Alignment for Unsupervised Federated Source-Free Domain Adaptation**  
  M. Yashwanth, S. Koti, A. Singh, S. Marjit, **A. Chakraborty**  
...
- **Optimizing Federated Learning for Scalable Power-demand Forecasting in Microgrids**  
  R. Banerjee, S. Koti, G. Singh, **A. Chakraborty**, G. Gurrala, B. Jagyasi and Y. Simmhan  
  *IEEE Conference on eScience (eScience)*, 2025

- **Enhancing 3D Referential Grounding by Learning Coarse Spatial Relationships**  
  S. Joshi, A. Tripathi, V. Gopalakrishnan, **A. Chakraborty**  
  *International Conference on Pattern Recognition (ICPR)*, 2024

- **Dynamic Data Selection for Efficient SSL via Coarse-to-Fine Refinement**  
  A. Tripathi, P. Shenoy, **A. Chakraborty**  
  *European Conference on Computer Vision (ECCV)*, 2024

- **Data-free Defense of Black Box Models Against Adversarial Attacks**  
  G. K. Nayak, I. Khatri, R. Rawal, **A. Chakraborty**  
  *IEEE Conference on Computer Vision and Pattern Recognition Workshops (CVPR-W)*, 2024

- **Sketch-guided Image Inpainting with Partial Discrete Diffusion Process**  
  N. Sharma, A. Tripathi, **A. Chakraborty**, A. Mishra  
  *IEEE Conference on Computer Vision and Pattern Recognition Workshops (CVPR-W)*, 2024
...
- **Minimizing Layerwise Activation Norm Improves Generalization in Federated Learning**  
  M. Yashwanth, G. K. Nayak, H. Rangwani, A. Singh, R. V. Babu, **A. Chakraborty**  
  *Winter Conference on Applications of Computer Vision (WACV)*, 2024

- **Edges to Shapes to Concepts: Adversarial Augmentation for Robust Vision**  
  A. Tripathi, R. Singh, **A. Chakraborty**, P. Shenoy  
  *IEEE Conference on Computer Vision and Pattern Recognition (CVPR)*, 2023

- **G-PReDICT: Generalizable Person Re-ID using Domain Invariant Contrastive Techniques**  
  C. Jambigi, U. Masud, **A. Chakraborty**  
  *Indian Conference on Computer Vision, Graphics and Image Processing (ICVGIP)*, 2022 (Oral)
...
- **CoNMix for Source-free Single and Multi-target Domain Adaptation**  
  V. Kumar, R. Lal, H. Patil, **A. Chakraborty**  
  *Winter Conference on Applications of Computer Vision (WACV)*, 2023

- **DE-CROP: Data-efficient Certified Robustness for Pretrained Classifiers**  
  G. K. Nayak, R. Rawal, **A. Chakraborty**  
  *Winter Conference on Applications of Computer Vision (WACV)*, 2023

- **Uncertainty-Aware Adaptation for Self-Supervised 3D Human Pose Estimation**  
  J. N. Kundu, S. Seth, Y. M. Pradyumna, V. Jampani, **A. Chakraborty**, R. Venkatesh Babu  
  *IEEE Conference on Computer Vision and Pattern Recognition (CVPR)*, 2022

- **Holistic Approach to Measure Sample-level Adversarial Vulnerability and its Utility in Building Trustworthy Systems**  
  G. K. Nayak, R. Rawal, R. Lal, H. Patil, **A. Chakraborty**  
  *IEEE Conference on Computer Vision and Pattern Recognition Workshops (CVPR-W)*, 2022
...
- **Non-local Latent Relation Distillation for Self-Adaptive 3D Human Pose Estimation**  
  J. N. Kundu, S. Seth, A. Jamkhandi, Y. M. Pradyumna, V. Jampani, **A. Chakraborty**, R. Venkatesh Babu  
  *Advances in Neural Information Processing Systems (NeurIPS)*, 2021

- **MMD-ReID: A Simple but Effective Solution for Visible-Thermal Person ReID**  
  C. Jambigi, R. Rawal, **A. Chakraborty**  
...
- **Self-Supervised 3D Human Pose Estimation Via Part Guided Novel Image Synthesis**  
  J. N. Kundu\*, S. Seth\*, V. Jampani, R. Mugalodi, R. Venkatesh Babu, **A. Chakraborty** (\* Jointly first authored)  
  *IEEE Conference on Computer Vision and Pattern Recognition (CVPR)*, 2020 (Oral)

- **Kinematic-Structure-Preserved Representation for Unsupervised 3D Human Pose Estimation**  
  J. N. Kundu\*, S. Seth\*, R. M. Venkatesh\*, R. Mugalodi, R. Venkatesh Babu, **A. Chakraborty** (\* Jointly first authored)  
  *Conference of the American Association for Artificial Intelligence (AAAI)*, 2020 (Oral)

- **DeGAN: Data-enriching GAN for retrieving Representative Samples from a Trained Classifier**  
  S. Addepalli, G. K. Nayak, **A. Chakraborty**, R. Venkatesh Babu  
  *Conference of the American Association for Artificial Intelligence (AAAI)*, 2020

- **Text-based Person Search via Attribute-aided Matching**  
  S. Aggarwal, R. Venkatesh Babu, **A. Chakraborty**  
  *Winter Conference on Applications of Computer Vision (WACV)*, 2020

- **Zero Shot Knowledge Distillation in Deep Networks**  
  G. K. Nayak\*, M. K. Reddy\*, V. Shaj\*, R. Venkatesh Babu, **A. Chakraborty** (\* Jointly first authored)  
  *International Conference on Machine Learning (ICML)*, 2019

- **From Strings to Things: Knowledge-enabled VQA Model that can Read and Reason**  
  A. K. Singh, A. Mishra, S. Shekhar, **A. Chakraborty**  
  *International Conference on Computer Vision (ICCV)*, 2019 (Oral)

- **Consistent Re-identification in a Camera Network**  
  A. Das\*, **A. Chakraborty**\*, A. K. Roy-Chowdhury (\* Jointly first authored)  
...
- **Introduction to Data Science [DS 215]**: Aug 2025, Aug 2024, Aug 2023, Aug 2022
- **Topics in Visual Analytics [DS 363]**: Aug 2025
- **Data Analysis and Visualization [DS 294]**: Jan 2022, Jan 2020, Jan 2018
- **Video Analytics [DS 263]**: Aug 2021, Aug 2019 (with [Prof. R. Venkatesh Babu](https://cds.iisc.ac.in/faculty/venky/))
- **Deep Learning for Computer Vision [DS 265]**: Jan 2020 (with [Prof. R. Venkatesh Babu](https://cds.iisc.ac.in/faculty/venky/))
